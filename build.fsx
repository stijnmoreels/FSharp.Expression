...
let project = "FSharp.Expression"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "F# Implementation for expression parsing"
...
let tags = "F# Expression"

// File system information
let solutionFile  = "FSharp.Expression.sln"
...
let gitOwner = "Personal"
let gitHome = sprintf "%s/%s" "https://github.com/stijnmoreels/FSharp.Expression" gitOwner

// The name of the project on GitHub
let gitName = "FSharp.Expression"

// The url for the raw files hosted
let gitRaw = environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/Personal"
...
Target "RunTests" (fun _ ->
    ...
    |> xUnit2 (fun p ->
        { p with
            ...
            ToolPath = @"packages\test\xunit.runner.console\tools\xunit.console.exe" })
)

// --------------------------------------------------------------------------------------
// Inspect with FSharp.Lint
